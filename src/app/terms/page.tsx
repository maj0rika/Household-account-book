...
const PAGE_TITLE = "서비스 이용약관 — 가계부";
const PAGE_DESCRIPTION = "가계부 서비스의 이용 조건, 회원 의무, 콘텐츠 권리, AI 기능 안내, 분쟁 해결 기준을 안내합니다.";
			...
			<article aria-labelledby="terms-title" className="space-y-8">
				<header className="space-y-4">
					...
					<div className="space-y-2">
						<h1 id="terms-title" className="text-2xl font-bold">서비스 이용약관</h1>
				...
				<div className="space-y-8 text-sm leading-relaxed text-foreground/90">
					...
					<Section title="제12조 (개인정보 보호)">
						<p>
							...
							<Link
								href="/privacy"
								className="font-semibold text-foreground underline underline-offset-2 decoration-primary hover:text-foreground/80 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
							>
								개인정보처리방침
							</Link>
							에 따릅니다.
				...
				<footer>
					<p className="text-xs text-muted-foreground">
						본 약관은 <time dateTime={EFFECTIVE_DATE}>2026년 3월 16일</time>부터 적용됩니다.
					</p>
				</footer>
			</article>
		</main>
